...
//                     Text(
//                       localizations.t('viewReward.back'),
//                       style: TextStyle(color: Colors.white, fontSize: 20.0),
//                     ),
//                   ],
//                 ),
//               ),
//               Text(localizations.t('viewReward.title')),
//             ],
//           ),
//           centerTitle: true,
...
//                     child: Container(
//                       child: Text(
//                         localizations.t('viewReward.rewardDescription'),
...
//                     padding: const EdgeInsets.symmetric(horizontal: 10.0),
//                     child: Text(
//                       localizations.t('viewReward.rewardImage'),
//                       style: TextStyle(color: Colors.white, fontSize: 15.0),
//                     ),
//                   ),
//                   SizedBox(height: 20.0),
